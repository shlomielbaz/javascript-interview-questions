...
const findPath = (root, targetNode, path) => {
  path = path || [];
...
function LCA(root, a, b) {
  ...
  let pathToA = findPath(root, a);
  let pathToB = findPath(root, b);
...
console.log('The lowest common ancestor (LCA) is: ', LCA(root, nodes[0], nodes[8]));
