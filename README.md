...
<ol>
  ...
  <li>
    ...
    Link to the code: <a href="convert-callback-to-promise.js">convert-callback-to-promise.js</a><br />
  ...
  <li>
    ...
    Link to the code: <a href="compute-closest-to-zero.js">compute-closest-to-zero.js</a>
    <br /><br />
  </li>
  ...
  <li>
    ...
    Link to the code: <a href="wait-until-ready.js">wait-until-ready.js</a>
    <br /><br />
  </li>
  
  <li>
    Add new item to a LinkedList in a sorted way<br />
    Link to the code: <a href="add-sorted-to-linkedlist.ts">add-sorted-to-linkedlist.ts</a>
    <br /><br />
  </li>
  
  <li>
    Write a function that gets an array and shuffle it<br />
    Link to the code: <a href="array-shuffle.js">array-shuffle.js</a>
    <br /><br />
  </li>
  ...
  <li>
    ...
    Link to the code: <a href="LCA.js">LCA.js</a>
    <br /><br />
  </li>
...
<li>
  ...
  Your task is write a solution the returns the combination of sequence of 4 seats,<br />
    the 'sequence' of 4 can be achived from:<br />
      ...
      [ - | - | - ]&nbsp;&nbsp;&nbsp;[ X | X | X | X ]&nbsp;&nbsp;&nbsp;[ - | - | - ]<br />
      [ - | - | - ]&nbsp;&nbsp;&nbsp;[ - | - | X | X ]&nbsp;&nbsp;&nbsp;[ X | X | - ]<br /><br />
    Link to the code: <a href="available-4-seats.js">available-4-seats.js</a>
    <br /><br />
</li>
...
Which prime, below one-milion, can be written as a sum of the most consecutive primes?<br />
    Link to the code: <a href="consecutive-prime.js">consecutive-prime.js</a>
    <br /><br />
</li>
...
"The_Stealth_Warrior" gets converted to "TheStealthWarrior"<br />
    Link to the code: <a href="convert-to-camel-case.js">convert-to-camel-case.js</a>
    <br /><br />
</li>

<li>
event loop print ordering<br />
Link to the code: <a href="eventloop-trace.js">eventloop-trace.js</a>
  <br /><br />
</li>
...
Link to the code: <a href="filter-by-length.js">filter-by-length.js</a>
  <br /><br />
</li>
...
Link to the code: <a href="power-all-subsets.js">power-all-subsets.js</a>
  <br /><br />
</li>
